...
import { createLayerpage } from './LayerpageStory';
import "./Layerpage.css";
import LayerpageAPIdoc from "./LayerpageAPIdoc.mdx";

// More on how to set up stories at: https://storybook.js.org/docs/writing-stories
export default {
  title: "Components/Layerpage",
  tags: ["autodocs"],
  parameters: {
    docs: {
      source: {
      ...
      page: LayerpageAPIdoc,
    },
  },
  // decorators: [withActions],
  render: ({ ...args }) => {
    // You can either use a function to create DOM elements or use a plain html string!
    let instance = createLayerpage({ ...args });
    return `<div></div>`;
