      ...
      <table className="sb-unstyled table-content">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>是否有排序功能，`false`關閉排序功能，`true`預設為 asc(升冪)、desc(降冪)</td>
          ...
          <tr>
            <td className="font-bold text-center">minWidth</td>
            <td className="text-center">`undefined`</td>
            <td className="text-center">number</td>
            <td>最小寬度(單位為px)</td>
          </tr>
          <tr>
            <td className="font-bold text-center">maxWidth</td>
            <td className="text-center">`undefined`</td>
            <td className="text-center">number</td>
            <td>最大寬度(單位為px)</td>
          </tr>
...
<div className="sb-unstyled table-container overflow-hidden">
  <table className="sb-unstyled table-content">
    ...
    <tbody>
      ...
      <tr>
        <td>`.getCurrentData(pageNum)`</td>
        <td>取得當前頁rows的data資料</td>
      </tr>
      <tr>
      ...
      <tr>
        <td>`.checkPageSelected()`</td>
        <td>檢查當頁全部rows是否全選</td>
      </tr>
      <tr>
        <td>`.selectedFullPage(pageNum)`</td>
        <td>全選當前頁所有列</td>
      </tr>
      <tr>
        <td>`.getFiltedRows(fn)`</td>
        <td>取得指定過濾條件data</td>
      </tr>
      <tr>
        <td>`.searchInFilter(keyWord)`</td>
        <td>關鍵字過濾</td>
      </tr>
      <tr>
        <td>`.clearSelected()`</td>
