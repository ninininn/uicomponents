...
<span className="sb-unstyled data-type inherits">related to flowbite <a href="https://flowbite.com/docs/components/toast/" className="linkout">Dismiss</a></span>
...
<span className="sb-unstyled data-type inherits">related to flowbite <a href="https://flowbite.com/docs/components/modal/" className="linkout">Modal</a></span>
...
<span className="sb-unstyled data-type inherits">related to flowbite <a href="https://flowbite.com/docs/components/popover/" className="linkout">Popover</a></span>
