import{u as l,j as e,M as t}from"./iframe-BVS5Mtot.js";import"./preload-helper-DLLWEBaG.js";function r(n){const s={blockquote:"blockquote",br:"br",code:"code",h3:"h3",li:"li",p:"p",pre:"pre",strong:"strong",ul:"ul",...l(),...n.components};return e.jsxs(e.Fragment,{children:[e.jsxs(s.p,{children:[e.jsx(t,{title:"Configure your project"}),`# 工具函式\r
...
`,e.jsxs(s.p,{children:[e.jsx("span",{className:"sb-unstyled methods",children:".addClass(element, classes)"}),`-\r
`,e.jsx(s.strong,{children:"Parameters"})," - ",e.jsxs(s.strong,{children:["element",e.jsx("span",{className:"text-red-600",children:"*"})]}),` DOM元素\r
`,e.jsx("span",{className:"sb-unstyled data-type element",children:"HTMLElement"}),"- ",e.jsxs(s.strong,{children:[`classes\r
`,e.jsx("span",{className:"text-red-600",children:"*"})]}),` 要加入的 classes\r
...
`})}),`
`,e.jsxs(s.p,{children:[e.jsx("span",{className:"sb-unstyled methods",children:".removeClass(element, classes)"}),`-\r
`,e.jsx(s.strong,{children:"Parameters"})," - ",e.jsxs(s.strong,{children:["element",e.jsx("span",{className:"text-red-600",children:"*"})]}),` DOM元素\r
`,e.jsx("span",{className:"sb-unstyled data-type element",children:"HTMLElement"}),"- ",e.jsxs(s.strong,{children:[`classes\r
`,e.jsx("span",{className:"text-red-600",children:"*"})]}),` 要移除的 classes\r
`,e.jsx("span",{className:"sb-unstyled data-type arr",children:"array"})]}),`
...
`,e.jsxs(s.li,{children:[e.jsx(s.strong,{children:"Parameters"})," - ",e.jsxs(s.strong,{children:["element",e.jsx("span",{className:"text-red-600",children:"*"})]}),` DOM元素\r
`,e.jsx("span",{className:"sb-unstyled data-type element",children:"HTMLElement"}),`-\r
`,e.jsx(s.strong,{children:"excludeClasses"}),` 除外classes\r
`,e.jsx("span",{className:"sb-unstyled data-type arr",children:"array"})]}),`
`]}),`
...
`})}),`
`,e.jsxs(s.p,{children:[e.jsx("span",{className:"sb-unstyled methods",children:".setText(element, text)"}),`-\r
`,e.jsx(s.strong,{children:"Parameters"})," - ",e.jsxs(s.strong,{children:["element",e.jsx("span",{className:"text-red-600",children:"*"})]}),` DOM元素\r
`,e.jsx("span",{className:"sb-unstyled data-type element",children:"HTMLElement"}),"- ",e.jsxs(s.strong,{children:[`text\r
`,e.jsx("span",{className:"text-red-600",children:"*"})]}),` 文字內容\r
...
`,e.jsxs(s.li,{children:[e.jsx(s.strong,{children:"Parameters"})," - ",e.jsxs(s.strong,{children:["element",e.jsx("span",{className:"text-red-600",children:"*"})]}),` DOM元素\r
`,e.jsx("span",{className:"sb-unstyled data-type element",children:"HTMLElement"}),`-\r
`,e.jsxs(s.strong,{children:["attributeName",e.jsx("span",{className:"text-red-600",children:"*"})]}),` 屬性名稱\r
`,e.jsx("span",{className:"sb-unstyled data-type str",children:"string"}),"- ",e.jsxs(s.strong,{children:[`attributeValue\r
`,e.jsx("span",{className:"text-red-600",children:"*"})]}),` 要設定的值\r
`,e.jsx("span",{className:"sb-unstyled data-type str",children:"string"})]}),`
`]}),`
...
`,e.jsxs(s.li,{children:[e.jsx(s.strong,{children:"Parameters"})," - ",e.jsxs(s.strong,{children:["element",e.jsx("span",{className:"text-red-600",children:"*"})]}),` DOM元素\r
`,e.jsx("span",{className:"sb-unstyled data-type element",children:"HTMLElement"}),`-\r
`,e.jsxs(s.strong,{children:["propertyName",e.jsx("span",{className:"text-red-600",children:"*"})]}),` CSS propertyName\r
`,e.jsx("span",{className:"sb-unstyled data-type str",children:"string"}),"- ",e.jsxs(s.strong,{children:[`propertyValue\r
`,e.jsx("span",{className:"text-red-600",children:"*"})]}),` 要設定的值\r
`,e.jsx("span",{className:"sb-unstyled data-type str",children:"string"})]}),`
`]}),`
...
`,e.jsxs(s.p,{children:[e.jsx("span",{className:"sb-unstyled methods",children:"function compareNum(arrayNum)"}),`-\r
`,e.jsx(s.strong,{children:"Parameters"})," - ",e.jsxs(s.strong,{children:["arrayNum",e.jsx("span",{className:"text-red-600",children:"*"})]}),` 數組\r
`,e.jsx("span",{className:"sb-unstyled data-type arr",children:"array"}),"- ",e.jsx(s.strong,{children:"Returns"}),`\r
回傳已排序的數組參數`]}),`
`,e.jsx(s.pre,{children:e.jsx(s.code,{className:"language-javascript",children:`let sortNumArr = compareNum([15, 13]); //[13, 15]
`})}),`
`,e.jsxs(s.p,{children:[e.jsx("span",{className:"sb-unstyled methods",children:"function checkDevice()"}),"- ",e.jsx(s.strong,{children:"Returns"}),`\r
判斷裝置尺寸`]}),`
`,e.jsx(s.pre,{children:e.jsx(s.code,{className:"language-javascript",children:`// other opereations...\r
checkDevice();
`})}),`
...
`,e.jsx(s.pre,{children:e.jsx(s.code,{className:"language-javascript",children:`  const paletteConfig = {\r
    colorCounts: 1, //顏色數量\r
    alpha: 1, //透明度\r
    colorMode: 'hsl', //色碼模式\r
    style: 'random', //隨機(random)、相近色(same)、對比色(contrast)\r
    tone: 'red', //指定色系(red,yellow,green,cyan,blue,purple)\r
    offset: 20 //偏移\r
  }
`})}),`
`]}),`
...
`]}),`
`]}),`
`,e.jsxs(s.p,{children:[e.jsx("span",{className:"sb-unstyled methods",children:"ColorFormat"}),`> 顏色相關轉換函式\r
...
`,e.jsxs(s.p,{children:[e.jsx("span",{className:"sb-unstyled methods",children:"ColorHelper"}),`> 顏色相關輔助函式\r
`,e.jsx(s.code,{children:"Color.js"})]}),`
`,e.jsx("div",{className:"sb-unstyled table-container overflow-hidden",children:e.jsxs("table",{className:"sb-unstyled table-content",children:[e.jsx("thead",{children:e.jsxs("tr",{className:"text-center",children:[e.jsx("td",{children:"methods"}),e.jsx("td",{children:"descriptions"})]})}),e.jsxs("tbody",{children:[e.jsxs("tr",{children:[e.jsx("td",{children:e.jsx(s.code,{children:".getRandomNum(min, max)"})}),e.jsx("td",{children:"隨機取得一個在指定區間min~max的數字"})]}),e.jsxs("tr",{children:[e.jsx("td",{children:e.jsx(s.code,{children:".randomDigit()"})}),e.jsx("td",{children:"隨機取得一個16進制數字"})]}),e.jsxs("tr",{children:[e.jsx("td",{children:e.jsx(s.code,{children:".randomHexColor()"})}),e.jsx("td",{children:"隨機取得一個HEX色碼"})]}),e.jsxs("tr",{children:[e.jsx("td",{children:e.jsx(s.code,{children:".tohexDigits(strDigit)"})}),e.jsx("td",{children:"將一個十進制數字轉換為十六進制"})]}),e.jsxs("tr",{children:[e.jsx("td",{children:e.jsx(s.code,{children:".circular_distance(a,b)"})}),e.jsx("td",{children:"以圓形計算兩值之間差值(ex.359-1=2)"})]})]})]})})]})}function a(n={}){const{wrapper:s}={...l(),...n.components};return s?e.jsx(s,{...n,children:e.jsx(r,{...n})}):r(n)}export{a as default};
