import{u as l,j as e,M as d,T as r,P as c,C as i}from"./iframe-BWigM8VB.js";import"./preload-helper-DLLWEBaG.js";function t(n){const s={blockquote:"blockquote",br:"br",code:"code",h1:"h1",h3:"h3",hr:"hr",li:"li",p:"p",pre:"pre",strong:"strong",ul:"ul",...l(),...n.components};return e.jsxs(e.Fragment,{children:[e.jsx(d,{isTemplate:!0,title:"How to use DraggableItem"}),`
`,e.jsx(r,{}),`
...
`]}),`
`,e.jsx("div",{className:"sb-unstyled table-container",children:e.jsxs("table",{className:"sb-unstyled table-content",children:[e.jsx("thead",{children:e.jsxs("tr",{className:"text-center",children:[e.jsx("td",{children:"property"}),e.jsx("td",{children:"default"}),e.jsx("td",{children:"type"}),e.jsx("td",{children:"descriptions"})]})}),e.jsxs("tbody",{children:[e.jsxs("tr",{children:[e.jsx("td",{className:"font-bold",children:"UItype"}),e.jsx("td",{children:"DraggableItem"}),e.jsx("td",{children:"string"}),e.jsxs("td",{children:["繼承自",e.jsx(s.code,{children:"BaseComponent"}),"的屬性，代表該元件名稱"]})]}),e.jsxs("tr",{children:[e.jsx("td",{className:"font-bold",children:"sortable"}),e.jsx("td",{children:e.jsx(s.code,{children:"Sortable"})}),e.jsx("td",{children:"Object"}),e.jsxs("td",{children:["SortableJS ",e.jsx(s.code,{children:"Sortable"})," 物件"]})]})]})]})}),`
`,e.jsx(s.hr,{}),`
`,e.jsxs(s.blockquote,{children:[`
...
`,e.jsx("div",{className:"sb-unstyled table-container overflow-hidden",children:e.jsxs("table",{className:"sb-unstyled table-content",children:[e.jsx("thead",{children:e.jsxs("tr",{className:"text-center",children:[e.jsx("td",{children:"methods"}),e.jsx("td",{children:"descriptions"})]})}),e.jsxs("tbody",{children:[e.jsxs("tr",{children:[e.jsx("td",{children:e.jsx(s.code,{children:".setHandler(type,fn)"})}),e.jsx("td",{children:"設定對應事件的function"})]}),e.jsxs("tr",{children:[e.jsx("td",{children:e.jsx(s.code,{children:".getChildSort()"})}),e.jsx("td",{children:"取得子元素HTMLCollection"})]}),e.jsxs("tr",{children:[e.jsx("td",{children:e.jsx(s.code,{children:".getSortingIndex()"})}),e.jsx("td",{children:"取得指定data-*的順序陣列"})]}),e.jsxs("tr",{children:[e.jsx("td",{children:e.jsx(s.code,{children:".sort(order,animation)"})}),e.jsx("td",{children:"用指定排序(order)來排列元素"})]})]})]})}),`
`,e.jsx(s.hr,{}),`
...
`]}),`
`]}),`
`]})]})}function h(n={}){const{wrapper:s}={...l(),...n.components};return s?e.jsx(s,{...n,children:e.jsx(t,{...n})}):t(n)}export{h as default};
