import{u as d,j as s,M as r,T as c,P as i,C as a}from"./iframe-BURo3Kbc.js";import"./preload-helper-DLLWEBaG.js";function l(n){const e={blockquote:"blockquote",br:"br",code:"code",h1:"h1",h3:"h3",h4:"h4",hr:"hr",li:"li",p:"p",pre:"pre",strong:"strong",ul:"ul",...d(),...n.components};return s.jsxs(s.Fragment,{children:[s.jsx(r,{isTemplate:!0,title:"How to use Cards"}),`
`,s.jsx(c,{}),`
...
`,s.jsx(e.p,{children:"卡片元件設定較為複雜，Controls區塊包含初始化時可設定的相關參數(title, cardSize)及資料設定之參數細節(infoList)。"}),`
`,s.jsx(a,{}),`
`,s.jsx(e.hr,{}),`
`,s.jsx(e.h1,{id:"usage-api",children:"Usage API"}),`
`,s.jsxs(e.p,{children:["初始化 BasicInfoCard 元件，帶入 ",s.jsx(e.code,{children:"title"}),"、",s.jsx(e.code,{children:"infoList"}),"及",s.jsx(e.code,{children:"cardSize"}),"參數。"]}),`
`,s.jsx(e.pre,{children:s.jsx(e.code,{className:"language-javascript",children:`new BasicInfoCard(title, infoList, cardSize = 1);
`})}),`
...
`,s.jsx(e.p,{children:"傳入卡片面版的標題文字"}),`
`,s.jsx("br",{}),`
`]}),`
`,s.jsxs(e.li,{children:[`
...
`})}),`
`,s.jsx("br",{}),`
`,s.jsxs("div",{className:"sb-unstyled note-msg",children:[s.jsx("span",{children:"label 及 value 屬性傳入型別說明"}),s.jsxs("p",{children:["原則上一個",s.jsx(e.code,{children:"{}"}),"內的屬性會視為同一欄(row)，如果要在同一個row顯示多組資料，可以在",s.jsx(e.code,{children:"label"}),"及",s.jsx(e.code,{children:"value"}),"屬性帶入array型別的資料。(但上方control處先以單一資料呈現操作)"]}),s.jsxs("p",{children:["需要注意的是，如果",s.jsx(e.code,{children:"label"}),"傳入一陣列，那",s.jsx(e.code,{children:"value"}),"也需要傳入陣列，如果對應資料尚未知，可以先放入",s.jsx(e.code,{children:'" "'}),"作為替代；然而如果沒有帶入",s.jsx(e.code,{children:"value"}),"，但是有",s.jsx(e.code,{children:"customInner"}),"，則預設會直接把 label & customInner 視為同一組。"]}),s.jsx("br",{}),s.jsx("div",{className:"examples",children:s.jsxs(e.ul,{children:[`
`,s.jsxs(e.li,{children:[`
`,s.jsx("span",{className:"sb-unstyled examples-title",children:'label:"A", value:"B"'}),`
`]}),`
`]})}),s.jsx("div",{className:"examples",children:s.jsxs(e.ul,{children:[`
`,s.jsxs(e.li,{children:[`
...
`]})}),s.jsx("div",{className:"examples",children:s.jsxs(e.ul,{children:[`
`,s.jsxs(e.li,{children:[`
`,s.jsxs("span",{className:"sb-unstyled examples-title",children:['label:"A", customInner:',s.jsx(e.code,{children:"<div></div>"})]}),`
`]}),`
`]})})]}),`
`,s.jsx("br",{}),`
`]}),`
...
`]}),`
`,s.jsx("div",{className:"sb-unstyled table-container overflow-hidden",children:s.jsxs("table",{className:"sb-unstyled table-content",children:[s.jsx("thead",{children:s.jsxs("tr",{className:"text-center",children:[s.jsx("td",{children:"property"}),s.jsx("td",{children:"default"}),s.jsx("td",{children:"type"}),s.jsx("td",{children:"descriptions"}),s.jsx("td",{children:"inherit"})]})}),s.jsxs("tbody",{children:[s.jsxs("tr",{children:[s.jsx("td",{className:"font-bold",children:"UItype"}),s.jsx("td",{children:"Card"}),s.jsx("td",{children:"string"}),s.jsxs("td",{children:["繼承自",s.jsx(e.code,{children:"BaseComponent"}),"的屬性，代表該元件名稱"]}),s.jsxs("td",{children:[s.jsx(e.code,{children:"Card"})," 類別"]})]}),s.jsxs("tr",{children:[s.jsx("td",{className:"font-bold",children:"cardContainer"}),s.jsx("td",{children:"-"}),s.jsx("td",{children:"HTMLElement"}),s.jsxs("td",{children:["當前顯示的圖示，",s.jsx(e.code,{children:"style"}),"為toggle時才會出現"]}),s.jsxs("td",{children:[s.jsx(e.code,{children:"Card"})," 類別"]})]}),s.jsxs("tr",{children:[s.jsx("td",{className:"font-bold",children:"title"}),s.jsx("td",{children:"-"}),s.jsx("td",{children:"string"}),s.jsx("td",{children:"卡片標題(Header)"}),s.jsxs("td",{children:[s.jsx(e.code,{children:"Card"})," 類別"]})]}),s.jsxs("tr",{children:[s.jsx("td",{className:"font-bold",children:"blocks"}),s.jsx("td",{children:"[]"}),s.jsx("td",{children:"array"}),s.jsx("td",{children:"記錄此卡片內所有內容區塊"})]}),s.jsxs("tr",{children:[s.jsx("td",{className:"font-bold",children:"infoList"}),s.jsx("td",{children:"[]"}),s.jsx("td",{children:"array"}),s.jsx("td",{children:"各區塊資料設定"})]})]})]})}),`
`,s.jsx("br",{}),`
`,s.jsxs(e.blockquote,{children:[`
...
`,s.jsx("div",{className:"sb-unstyled table-container overflow-hidden",children:s.jsxs("table",{className:"sb-unstyled table-content",children:[s.jsx("thead",{children:s.jsxs("tr",{className:"text-center",children:[s.jsx("td",{children:"methods"}),s.jsx("td",{children:"descriptions"})]})}),s.jsxs("tbody",{children:[s.jsxs("tr",{children:[s.jsx("td",{children:s.jsx(e.code,{children:".addBlocks(addInfo, options = {})"})}),s.jsx("td",{children:"新增項目or欄位"})]}),s.jsxs("tr",{children:[s.jsx("td",{children:s.jsx(e.code,{children:".clearBlocks()"})}),s.jsx("td",{children:"清空dataContent"})]}),s.jsxs("tr",{children:[s.jsx("td",{children:s.jsx(e.code,{children:".deleteBlock(label)"})}),s.jsx("td",{children:"刪除單一欄位UI&對應資料"})]}),s.jsxs("tr",{children:[s.jsx("td",{children:s.jsx(e.code,{children:".toggleBlock(groupId)"})}),s.jsx("td",{children:"切換區塊visible"})]}),s.jsxs("tr",{children:[s.jsx("td",{children:s.jsx(e.code,{children:".updateLabel(labelStr,updateStr)"})}),s.jsx("td",{children:"替換指定label的值"})]})]})]})}),`
...
`,s.jsxs(e.ul,{children:[`
`,s.jsxs(e.li,{children:[s.jsx(e.strong,{children:s.jsx(e.code,{children:"once"})})," 是否只新增一次"]}),`
`,s.jsxs(e.li,{children:[s.jsx(e.strong,{children:s.jsx(e.code,{children:"id"})})," 當once設定為true時，必須給定id作為groupId"]}),`
`]}),`
`]}),`
`]}),`
`]}),`
`]}),`
`,s.jsx(e.pre,{children:s.jsx(e.code,{className:"language-javascript",children:`  BasicInfoCard.addBlocks(buildno, { once: true, id:"buildno_1" });
`})}),`
`,s.jsx("br",{}),`
`,s.jsx("span",{className:"sb-unstyled methods",children:".clearBlocks()"}),`
`,s.jsxs(e.ul,{children:[`
`,s.jsx(e.li,{children:s.jsx(e.strong,{children:"清空dataContent(僅清空blocks節點，資料仍留存)"})}),`
`]}),`
`,s.jsx(e.pre,{children:s.jsx(e.code,{className:"language-javascript",children:` BasicInfoCard.clearBlocks(); 
`})}),`
...
`,s.jsxs(e.ul,{children:[`
`,s.jsxs(e.li,{children:[s.jsx(e.strong,{children:"parameters"}),s.jsx(e.br,{}),`
`,"可以切換同一個card內的group(有點類似tab)；使用",s.jsx(e.code,{children:"addBlock({once})"}),"後會綁定內部屬性",s.jsx(e.code,{children:"_groupId"}),"，可以用來切換"]}),`
`]}),`
`,s.jsx(e.pre,{children:s.jsx(e.code,{className:"language-javascript",children:`BasicInfoCard.toggleBlock("buildno_1");
`})}),`
`,s.jsx("span",{className:"sb-unstyled methods",children:".updateLabel(label,updateValue)"}),`
`,s.jsxs(e.ul,{children:[`
`,s.jsxs(e.li,{children:[s.jsx(e.strong,{children:"Parameters"}),`
`,s.jsxs(e.ul,{children:[`
`,s.jsxs(e.li,{children:[`
...
`]}),`
`]}),`
`,s.jsxs(e.p,{children:["傳入一個指定的",s.jsx(e.code,{children:"label"}),"文字，會去替換掉對應的",s.jsx(e.code,{children:"value"})]}),`
`,s.jsx(e.pre,{children:s.jsx(e.code,{className:"language-javascript",children:`BasicInfoCard.updateLabel("資料欄位A :","更新A");
`})}),`
`,s.jsx(e.hr,{}),`
`,s.jsx(e.h1,{id:"inherits",children:"Inherits"}),`
`,s.jsxs("div",{className:"sb-unstyled alert-msg",children:["做為",s.jsx(e.code,{children:"Card"}),"類別的子類別之一，繼承其相關屬性；但資料部分則涉及 ",s.jsx(e.code,{children:"Info"})," 類別，詳細請見個別說明。"]}),`
`,s.jsxs(e.blockquote,{children:[`
`,s.jsx(e.h3,{id:"card-類別",children:"Card 類別"}),`
`]}),`
`,s.jsxs(e.ul,{children:[`
`,s.jsxs(e.li,{children:[`
...
`]}),`
`,s.jsxs(e.li,{children:[`
`,s.jsx(e.h4,{id:"properties-內部屬性-2",children:"properties 內部屬性"}),`
...
`]}),`
`]})]})}function h(n={}){const{wrapper:e}={...d(),...n.components};return e?s.jsx(e,{...n,children:s.jsx(l,{...n})}):l(n)}export{h as default};
