import{B as o,c as C,U as a,u as w}from"./Utils-CnEs1UM_.js";import{C as b}from"./Checkbox-DtaN0PAK.js";/* empty css                 */import k from"./TableAPIdoc-CCgjFCdS.js";import"./iframe-yN89SlnH.js";import"./preload-helper-DLLWEBaG.js";let f=class extends o{constructor(e={},t=[]){let s;e.container?s=e.container:(s=document.createElement("div"),e.container=s);const i=document.createElement("table");super(s,e.theme||"var(--color-primary-200)"),this.UItype="Table",this.id=e.id,this.options={...this.config,...e},this.data=t,this.table=i,this.dataCounts=this.data.length,this._init()}get config(){return{id:"",container:null,limits:50,name:"defaultTable",classes:["table-container"],cols:[],selection:"checkbox",themeColor:"var(--color-primary-100)"}}_init(){this.tableBody=document.createElement("tbody"),this.tableHeader=new E(this.options.cols,this.options.selection);let e=this.options.cols.length;this.skeleton=new R({type:"table",colNum:this.options.selection?e+1:e}),C(this,this.options.cols),console.log(window.CoreContexts),this._render(),this._bindEvent()}_render(){super.setTheme(this.options.themeColor),a.setProperty(this._elem,"--theme",this._theme),this.dataCounts<1?this.tableBody.appendChild(this.skeleton.getElem()):this.skeleton.hide(),this.table.id=this.id,this.table.appendChild(this.tableHeader.getElem()),this.table.appendChild(this.tableBody),this._elem.appendChild(this.table),a.addClass(this.table,["table"]),a.addClass(this._elem,this.options.classes),this._updateRows(),this._renderRows(),this.options.elem.appendChild(this._elem)}_bindEvent(){}_setRows(e,t){let s=this;return e.map((l,c)=>new T(l,c,t,s))}_updateRows(){this.tableRows=this._setRows(this.data)}_renderRows(){let e=0;for(let t of this.tableRows)e++,e<=this.options.limits&&this.tableBody.appendChild(t.getElem())}setSize(e,t="auto"){a.setStyle(this._elem,"width",`${e}px`),a.setStyle(this._elem,"height",`${t}px`)}getTableData(){if(!this.tableRows){console.error("No Data Yet!");return}return this.tableRows.map(t=>t.data)}getSelected(){}setData(e){this.data=e,this.dataCounts=this.data.length,this._render(),this._pagination=new S({currentPage:1,pageSize:this.options.limits,total:this.dataCounts}),this._elem.after(this._pagination.getElem())}};class E extends o{constructor(e,t){const s=document.createElement("thead");super(s),this.UItype="TableHeader",this.cols=e,this.selection=this._checkSelection(t),this._init()}_init(){this._render()}_render(){const e=document.createElement("tr"),t=document.createDocumentFragment();if(this.selection.UItype==="Checkbox"){const s=document.createElement("th");s.appendChild(this.selection.getElem()),e.appendChild(s)}for(let s of this.cols){let i=document.createElement("th");a.setAttribute(i,"field",s.field),a.setText(i,s.title),t.appendChild(i)}e.appendChild(t),this._elem.appendChild(e)}_checkSelection(e){let t=document.createElement("th");if(e==="checkbox")return new b(t,{checked:!1});if(e==="radio")return}}class T extends o{constructor(e,t,s="checkbox",i){const l=document.createElement("tr");super(l),this.UItype="TableRow",this.data=e,this.selection=this._checkSelection(s),this.cells=this._setTableCells(this.data,w(i)),this.index=++t,this._init()}_init(){let e=document.createDocumentFragment();this.selection&&e.appendChild(this.selection.container);for(let t of this.cells)e.appendChild(t.getElem());this._elem.appendChild(e),a.setAttribute(this._elem,"index",this.index),this._bindEvent()}_bindEvent(){function e(){this.selection.getChecked()?a.setAttribute(this._elem,"rowSelected"):delete this._elem.dataset.rowselected}this.selection&&this.onevent(this.selection.getElem(),"change",e.bind(this))}_checkSelection(e){let t=document.createElement("td");if(e==="checkbox")return new b(t,{checked:!1});if(e==="radio")return}_setTableCells(e,t){return Object.values(e).map((i,l)=>new P(i,t[l]))}}class P extends o{constructor(e,t){const s=document.createElement("td");super(s),this.UItype="TableCell",this.dataValue=e,this.config=t,this._init()}_init(){this._render()}_render(){let{field:e,align:t="left"}=this.config;switch(t){case"center":a.addClass(this._elem,["text-center"]);break;case"right":a.addClass(this._elem,["text-right"]);break;default:a.clearClass(this._elem);break}a.setAttribute(this._elem,"field",e),a.setText(this._elem,this.dataValue)}}//! 未來要獨自拆出檔案
class S extends o{constructor(e){const t=document.createElement("div");a.addClass(t,["pagination"]),super(t),this.UItype="Pagination",this.currentPage=e.currentPage||1,this.total=Math.ceil(e.total/e.pageSize),this.pages=this._createPages(this.total,this.currentPage),this.handler=e.handler,this._init()}_init(){this._render(),console.log(this)}_render(){let e=document.createDocumentFragment();for(let t=0;t<this.pages.length;t++){let s=document.createElement("button");switch(s.type="button",this.pages[t].current&&a.setAttribute(s,"currentPage"),a.addClass(s,["page-item"]),this.pages[t].type){case"prev-page":a.setText(s,"<<");break;case"next-page":a.setText(s,">>");break;default:a.setText(s,this.pages[t].page);break}(this.pages[t].page>this.pages.length-2||this.pages[t].page<=0)&&(this.pages[t].page=null,s.disabled=!0),s.addEventListener("click",()=>{this.pages[t].onclick(this.pages[t].page)}),e.appendChild(s)}this._elem.appendChild(e)}_createPages(e,t){let s=this,i=[],l={type:"prev-page",page:this.currentPage-1,current:!1,onclick:this.goPage.bind(s)},c={type:"next-page",page:this.currentPage+1,current:!1,onclick:this.goPage.bind(s)};for(let r=0;r<e;r++){let g={type:"page",page:r+1,current:r+1===t,onclick:this.goPage.bind(s)};i.push(g)}return[l,...i,c]}setCurrentPage(e){this.currentPage=e}updatePage(){let e=this.currentPage;this.pages=this.pages.map(t=>{t.type==="prev-page"?t.page=e-1:t.type==="next-page"&&(t.page=e+1);let s=t.page===e;return t.current=s,t})}goPage(e){console.log(`go ${e} page`,this),this.setCurrentPage(e),this.updatePage(),this._elem.innerHTML="",this._render()}}//! 未來要獨自拆出檔案
class R extends o{constructor(e){let t;switch(e.type){case"table":t=document.createElement("tr");break;case"text":break;case"img":break;default:t=document.createElement("div")}super(t),this.UItype="Skeleton",this.options=e,this._render()}_render(){a.addClass(this._elem,["skeleton"]),this.defineType(this.options.type,this.options?.colNum)}defineType(e,t){switch(a.clearClass(this._elem,["skeleton"]),e){case"table":a.addClass(this._elem,["table-skeleton"]),this._elem.innerHTML=`
  ...
  // }
}`,...p.parameters?.docs?.source}}};const N=["Table"];export{p as Table,N as __namedExportsOrder,j as default};
