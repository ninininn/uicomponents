import{u as t,j as e,M as l,T as c,P as r,C as i}from"./iframe--i4Q7PXz.js";import"./preload-helper-DLLWEBaG.js";function d(n){const s={a:"a",blockquote:"blockquote",br:"br",code:"code",h1:"h1",h2:"h2",h3:"h3",hr:"hr",li:"li",p:"p",pre:"pre",strong:"strong",ul:"ul",...t(),...n.components};return e.jsxs(e.Fragment,{children:[e.jsx(l,{isTemplate:!0,title:"How to use Table"}),`
`,e.jsx(c,{}),`
...
`,e.jsx("div",{className:"sb-unstyled table-container",children:e.jsxs("table",{className:"sb-unstyled table-content",children:[e.jsx("thead",{children:e.jsxs("tr",{className:"text-center",children:[e.jsx("td",{children:"property"}),e.jsx("td",{children:"default"}),e.jsx("td",{children:"type"}),e.jsx("td",{children:"descriptions"}),e.jsx("td",{children:"options"})]})}),e.jsxs("tbody",{children:[e.jsxs("tr",{children:[e.jsx("td",{className:"font-bold text-center",children:"field"}),e.jsx("td",{className:"text-center",children:"-"}),e.jsx("td",{className:"text-center",children:"string"}),e.jsx("td",{children:"欄位屬性/特徵"})]}),e.jsxs("tr",{children:[e.jsx("td",{className:"font-bold text-center",children:"title"}),e.jsx("td",{className:"text-center",children:"-"}),e.jsx("td",{className:"text-center",children:"string"}),e.jsx("td",{children:"欄位文字"})]}),e.jsxs("tr",{children:[e.jsx("td",{className:"font-bold text-center",children:"sort"}),e.jsx("td",{className:"text-center",children:"asc"}),e.jsx("td",{className:"text-center",children:"string / boolean"}),e.jsxs("td",{children:["是否有排序功能，",e.jsx(s.code,{children:"false"}),"關閉排序功能，",e.jsx(s.code,{children:"true"}),"預設為 asc(升冪)、desc(降冪)"]}),e.jsxs("td",{children:[e.jsx(s.code,{children:"false"}),"關閉排序功能 / asc(升冪) / desc(降冪)"]})]}),e.jsxs("tr",{children:[e.jsx("td",{className:"font-bold text-center",children:"fixed"}),e.jsx("td",{className:"text-center",children:"false"}),e.jsx("td",{className:"text-center",children:"boolean"}),e.jsx("td",{children:"是否固定該欄"})]}),e.jsxs("tr",{children:[e.jsx("td",{className:"font-bold text-center",children:"align"}),e.jsx("td",{className:"text-center",children:"left"}),e.jsx("td",{className:"text-center",children:"string"}),e.jsx("td",{children:"欄位對齊位置"}),e.jsx("td",{children:" left / center / right"})]}),e.jsxs("tr",{children:[e.jsx("td",{className:"font-bold text-center",children:"template"}),e.jsx("td",{className:"text-center",children:"-"}),e.jsx("td",{className:"text-center",children:"function"}),e.jsx("td",{children:"自訂義tablecell的渲染函式"})]}),e.jsxs("tr",{children:[e.jsx("td",{className:"font-bold text-center",children:"print"}),e.jsx("td",{className:"text-center",children:e.jsx(s.code,{children:"true"})}),e.jsx("td",{className:"text-center",children:"boolean"}),e.jsx("td",{children:"列印是否要顯示"})]}),e.jsxs("tr",{children:[e.jsx("td",{className:"font-bold text-center",children:"visible"}),e.jsx("td",{className:"text-center",children:e.jsx(s.code,{children:"true"})}),e.jsx("td",{className:"text-center",children:"boolean"}),e.jsx("td",{children:"控制該欄顯示與否"})]}),e.jsxs("tr",{children:[e.jsx("td",{className:"font-bold text-center",children:"rowspan"}),e.jsx("td",{className:"text-center",children:"-"}),e.jsx("td",{className:"text-center",children:"number"}),e.jsx("td",{children:"控制合併列數量"})]}),e.jsxs("tr",{children:[e.jsx("td",{className:"font-bold text-center",children:"colspan"}),e.jsx("td",{className:"text-center",children:"-"}),e.jsx("td",{className:"text-center",children:"number"}),e.jsx("td",{children:"控制合併欄數量"})]}),e.jsxs("tr",{children:[e.jsx("td",{className:"font-bold text-center",children:"minWidth"}),e.jsx("td",{className:"text-center",children:e.jsx(s.code,{children:"undefined"})}),e.jsx("td",{className:"text-center",children:"number"}),e.jsx("td",{children:"最小寬度(單位為px)"})]}),e.jsxs("tr",{children:[e.jsx("td",{className:"font-bold text-center",children:"maxWidth"}),e.jsx("td",{className:"text-center",children:e.jsx(s.code,{children:"undefined"})}),e.jsx("td",{className:"text-center",children:"number"}),e.jsx("td",{children:"最大寬度(單位為px)"})]})]})]})}),`
`]}),`
`]}),`
`,e.jsx("br",{}),`
`,e.jsx(s.hr,{}),`
...
`,e.jsx("div",{className:"sb-unstyled table-container overflow-hidden",children:e.jsxs("table",{className:"sb-unstyled table-content",children:[e.jsx("thead",{children:e.jsxs("tr",{className:"text-center",children:[e.jsx("td",{children:"methods"}),e.jsx("td",{children:"descriptions"})]})}),e.jsxs("tbody",{children:[e.jsxs("tr",{children:[e.jsx("td",{children:e.jsx(s.code,{children:".setSelected(rowIndex)"})}),e.jsx("td",{children:"設定預設勾選列"})]}),e.jsxs("tr",{children:[e.jsx("td",{children:e.jsx(s.code,{children:".setData(dataArr)"})}),e.jsx("td",{children:"放入資料重新渲染"})]}),e.jsxs("tr",{children:[e.jsx("td",{children:e.jsx(s.code,{children:".setSize(width,height)"})}),e.jsx("td",{children:"設定表格尺寸"})]}),e.jsxs("tr",{children:[e.jsx("td",{children:e.jsx(s.code,{children:".reload()"})}),e.jsx("td",{children:"重新呼叫API抓資料"})]}),e.jsxs("tr",{children:[e.jsx("td",{children:e.jsx(s.code,{children:".getTableData()"})}),e.jsx("td",{children:"取得表格所有資料"})]}),e.jsxs("tr",{children:[e.jsx("td",{children:e.jsx(s.code,{children:".getRowData(index)"})}),e.jsx("td",{children:"取得指定列資料"})]}),e.jsxs("tr",{children:[e.jsx("td",{children:e.jsx(s.code,{children:".getSelectedRows()"})}),e.jsx("td",{children:"取得表格內所有選取的Row"})]}),e.jsxs("tr",{children:[e.jsx("td",{children:e.jsx(s.code,{children:".getCurrentData(pageNum)"})}),e.jsx("td",{children:"取得當前頁rows的data資料"})]}),e.jsxs("tr",{children:[e.jsx("td",{children:e.jsx(s.code,{children:".getCurrentPage()"})}),e.jsx("td",{children:"取得當前頁碼"})]}),e.jsxs("tr",{children:[e.jsx("td",{children:e.jsx(s.code,{children:".checkPageSelected()"})}),e.jsx("td",{children:"檢查當頁全部rows是否全選"})]}),e.jsxs("tr",{children:[e.jsx("td",{children:e.jsx(s.code,{children:".selectedFullPage(pageNum)"})}),e.jsx("td",{children:"全選當前頁所有列"})]}),e.jsxs("tr",{children:[e.jsx("td",{children:e.jsx(s.code,{children:".getFiltedRows(fn)"})}),e.jsx("td",{children:"取得指定過濾條件data"})]}),e.jsxs("tr",{children:[e.jsx("td",{children:e.jsx(s.code,{children:".exportTable()"})}),e.jsx("td",{children:"匯出成csv文件/pdf?"})]}),e.jsxs("tr",{children:[e.jsx("td",{children:e.jsx(s.code,{children:".getElem()"})}),e.jsx("td",{children:"取得table DOM節點"})]}),e.jsxs("tr",{children:[e.jsx("td",{children:e.jsx(s.code,{children:".setTheme()"})}),e.jsx("td",{children:"設定主題色"})]})]})]})}),`
`,e.jsx(s.p,{children:"--- # Pagination 元件"}),`
...
`,e.jsx("div",{className:"sb-unstyled table-container overflow-hidden",children:e.jsxs("table",{className:"sb-unstyled table-content",children:[e.jsx("thead",{children:e.jsxs("tr",{className:"text-center",children:[e.jsx("td",{children:"property"}),e.jsx("td",{children:"default"}),e.jsx("td",{children:"type"}),e.jsx("td",{children:"descriptions"}),e.jsx("td",{children:"inherits"})]})}),e.jsxs("tbody",{children:[e.jsxs("tr",{children:[e.jsx("td",{className:"font-bold",children:"UItype"}),e.jsx("td",{children:"Pagination"}),e.jsx("td",{children:"string"}),e.jsxs("td",{children:["繼承自",e.jsx(s.code,{children:"BaseComponent"}),"的屬性，代表該元件名稱"]}),e.jsx("td",{children:e.jsx(s.code,{children:"BaseComponent"})})]}),e.jsxs("tr",{children:[e.jsx("td",{className:"font-bold",children:"currentPage"}),e.jsx("td",{children:"1"}),e.jsx("td",{children:"number"}),e.jsx("td",{children:"當前頁數"})]}),e.jsxs("tr",{children:[e.jsx("td",{className:"font-bold",children:"total"}),e.jsx("td",{children:"-"}),e.jsx("td",{children:"number"}),e.jsx("td",{children:"資料總數"})]}),e.jsxs("tr",{children:[e.jsx("td",{className:"font-bold",children:"pages"}),e.jsx("td",{children:"[]"}),e.jsx("td",{children:"array"}),e.jsx("td",{children:"全部頁數(page)"})]}),e.jsxs("tr",{children:[e.jsx("td",{className:"font-bold",children:"handler"}),e.jsx("td",{children:"-"}),e.jsx("td",{children:"function"}),e.jsx("td",{children:"點擊各頁籤要執行的function"})]})]})]})}),`
`]}),`
`]}),`
`,e.jsx(s.h2,{id:"",children:e.jsx("br",{})}),`
`,e.jsx(s.h1,{id:"子元件",children:"子元件"}),`
`,e.jsx("div",{className:"sb-unstyled alert-msg",children:"不會直接操作，僅列出參考用"}),`
`,e.jsx("br",{}),`
`,e.jsxs(s.p,{children:[e.jsx("h3",{id:"TableHeader",children:"TableHeader"}),"- ",e.jsx(s.strong,{children:"properties 屬性"})]}),`
