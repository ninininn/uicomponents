import{u as d,j as e,M as c,T as r,P as t,C as i}from"./iframe-UhzdqN6V.js";import"./preload-helper-DLLWEBaG.js";function l(n){const s={blockquote:"blockquote",br:"br",code:"code",h1:"h1",h3:"h3",hr:"hr",li:"li",p:"p",pre:"pre",strong:"strong",ul:"ul",...d(),...n.components};return e.jsxs(e.Fragment,{children:[e.jsx(c,{isTemplate:!0,title:"How to use Checkbox"}),`
`,e.jsx(r,{}),`
...
`,e.jsx("div",{className:"sb-unstyled table-container overflow-hidden",children:e.jsxs("table",{className:"sb-unstyled table-content",children:[e.jsx("thead",{children:e.jsxs("tr",{className:"text-center",children:[e.jsx("td",{children:"methods"}),e.jsx("td",{children:"descriptions"}),e.jsx("td",{children:"inherit"})]})}),e.jsxs("tbody",{children:[e.jsxs("tr",{children:[e.jsx("td",{children:e.jsx(s.code,{children:".el"})}),e.jsx("td",{children:"取得該元件渲染的DOM節點元素"}),e.jsx("td",{children:e.jsx(s.code,{children:"BaseComponent"})})]}),e.jsxs("tr",{children:[e.jsx("td",{children:e.jsx(s.code,{children:".changeTheme(HEXstring)"})}),e.jsx("td",{children:"更改主題色"})]}),e.jsxs("tr",{children:[e.jsx("td",{children:e.jsx(s.code,{children:".setDisabled(boolean)"})}),e.jsx("td",{children:"更改顯示/操作與否"})]}),e.jsxs("tr",{children:[e.jsx("td",{children:e.jsx(s.code,{children:".getValue()"})}),e.jsxs("td",{children:["回傳",e.jsx(s.code,{children:"<input/>"})," value值"]})]}),e.jsxs("tr",{children:[e.jsx("td",{children:e.jsx(s.code,{children:".getChecked()"})}),e.jsxs("td",{children:["回傳",e.jsx(s.code,{children:"<input/>"})," checked值"]})]}),e.jsxs("tr",{children:[e.jsx("td",{children:e.jsx(s.code,{children:".setValue(value)"})}),e.jsxs("td",{children:["傳入要設定",e.jsx(s.code,{children:"<input/>"})," value值"]})]}),e.jsxs("tr",{children:[e.jsx("td",{children:e.jsx(s.code,{children:".setChecked(boolean)"})}),e.jsx("td",{children:"傳入要設定checked值"})]})]})]})}),`
`,e.jsx("span",{className:"sb-unstyled methods",children:".el"}),`
`,e.jsxs(s.ul,{children:[`
`,e.jsxs(s.li,{children:[e.jsx(s.strong,{children:"Returns"}),e.jsx(s.br,{}),`
`,"回傳主元件的DOM節點(HTMLElement) - ",e.jsx(s.code,{children:"<input/>"})]}),`
`]}),`
`,e.jsx(s.pre,{children:e.jsx(s.code,{className:"language-javascript",children:`Checkbox.el; 
`})}),`
...
`]}),`
`,e.jsx("p",{className:"sb-unstyled font-bold text-yellow-500",children:"Quick reference"}),`
`,e.jsx("div",{className:"sb-unstyled table-container overflow-hidden",children:e.jsxs("table",{className:"sb-unstyled table-content",children:[e.jsx("thead",{children:e.jsxs("tr",{className:"text-center",children:[e.jsx("td",{children:"methods"}),e.jsx("td",{children:"descriptions"}),e.jsx("td",{children:"inherit"})]})}),e.jsxs("tbody",{children:[e.jsxs("tr",{children:[e.jsx("td",{children:e.jsx(s.code,{children:".el"})}),e.jsx("td",{children:"取得該元件渲染的DOM節點元素"}),e.jsx("td",{children:e.jsx(s.code,{children:"BaseComponent"})})]}),e.jsxs("tr",{children:[e.jsx("td",{children:e.jsx(s.code,{children:".getValue(name)"})}),e.jsxs("td",{children:["取得群組內對應name屬性的",e.jsx(s.code,{children:"<input/>"}),"value-pair 物件"]})]}),e.jsxs("tr",{children:[e.jsx("td",{children:e.jsx(s.code,{children:".addCheckItems(item)"})}),e.jsx("td",{children:"在群組內加入新的Checkbox元件"})]})]})]})}),`
`,e.jsx("span",{className:"sb-unstyled methods",children:".el"}),`
`,e.jsxs(s.ul,{children:[`
`,e.jsxs(s.li,{children:[e.jsx(s.strong,{children:"Returns"}),e.jsx(s.br,{}),`
`,"回傳主元件的DOM節點(HTMLElement) - ",e.jsx(s.code,{children:"<ul/>"})]}),`
`]}),`
`,e.jsx(s.pre,{children:e.jsx(s.code,{className:"language-javascript",children:`CheckboxGroup.el; 
`})}),`
