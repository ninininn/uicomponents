import{u as d,j as e,M as l,T as c,P as r,C as i}from"./iframe-UhzdqN6V.js";import"./preload-helper-DLLWEBaG.js";function t(n){const s={a:"a",blockquote:"blockquote",br:"br",code:"code",h1:"h1",h2:"h2",h3:"h3",hr:"hr",li:"li",p:"p",pre:"pre",strong:"strong",ul:"ul",...d(),...n.components};return e.jsxs(e.Fragment,{children:[e.jsx(l,{isTemplate:!0,title:"How to use NavBar"}),`
`,e.jsx(c,{}),`
...
`,e.jsx("div",{className:"sb-unstyled table-container",children:e.jsxs("table",{className:"sb-unstyled table-content",children:[e.jsx("thead",{children:e.jsxs("tr",{className:"text-center",children:[e.jsx("td",{children:"property"}),e.jsx("td",{children:"default"}),e.jsx("td",{children:"type"}),e.jsx("td",{children:"descriptions"}),e.jsx("td",{children:"options"})]})}),e.jsxs("tbody",{children:[e.jsxs("tr",{children:[e.jsx("td",{className:"font-bold text-center",children:"field"}),e.jsx("td",{className:"text-center",children:"-"}),e.jsx("td",{className:"text-center",children:"string"}),e.jsx("td",{children:"欄位屬性/特徵"})]}),e.jsxs("tr",{children:[e.jsx("td",{className:"font-bold text-center",children:"title"}),e.jsx("td",{className:"text-center",children:"-"}),e.jsx("td",{className:"text-center",children:"string"}),e.jsx("td",{children:"欄位文字"})]}),e.jsxs("tr",{children:[e.jsx("td",{className:"font-bold text-center",children:"sort"}),e.jsx("td",{className:"text-center",children:"asc"}),e.jsx("td",{className:"text-center",children:"string / boolean"}),e.jsxs("td",{children:["是否有排序功能，",e.jsx(s.code,{children:"false"}),"關閉排序功能，asc(升冪)、desc(降冪)"]}),e.jsxs("td",{children:[e.jsx(s.code,{children:"false"}),"關閉排序功能 / asc(升冪) / desc(降冪)"]})]}),e.jsxs("tr",{children:[e.jsx("td",{className:"font-bold text-center",children:"fixed"}),e.jsx("td",{className:"text-center",children:"false"}),e.jsx("td",{className:"text-center",children:"boolean"}),e.jsx("td",{children:"是否固定該欄"})]}),e.jsxs("tr",{children:[e.jsx("td",{className:"font-bold text-center",children:"align"}),e.jsx("td",{className:"text-center",children:"left"}),e.jsx("td",{className:"text-center",children:"string"}),e.jsx("td",{children:"欄位對齊位置"}),e.jsx("td",{children:" left / center / right"})]}),e.jsxs("tr",{children:[e.jsx("td",{className:"font-bold text-center",children:"template"}),e.jsx("td",{className:"text-center",children:"-"}),e.jsx("td",{className:"text-center",children:"function"}),e.jsx("td",{children:"自訂義tablecell的渲染函式"})]}),e.jsxs("tr",{children:[e.jsx("td",{className:"font-bold text-center",children:"print"}),e.jsx("td",{className:"text-center",children:"true"}),e.jsx("td",{className:"text-center",children:"boolean"}),e.jsx("td",{children:"列印是否要顯示"})]}),e.jsxs("tr",{children:[e.jsx("td",{className:"font-bold text-center",children:"visible"}),e.jsx("td",{className:"text-center",children:e.jsx(s.code,{children:"true"})}),e.jsx("td",{className:"text-center",children:"boolean"}),e.jsx("td",{children:"控制該欄顯示與否"})]}),e.jsxs("tr",{children:[e.jsx("td",{className:"font-bold text-center",children:"rowspan"}),e.jsx("td",{className:"text-center",children:"-"}),e.jsx("td",{className:"text-center",children:"number"}),e.jsx("td",{children:"控制合併列數量"})]}),e.jsxs("tr",{children:[e.jsx("td",{className:"font-bold text-center",children:"colspan"}),e.jsx("td",{className:"text-center",children:"-"}),e.jsx("td",{className:"text-center",children:"number"}),e.jsx("td",{children:"控制合併欄數量"})]})]})]})}),`
`]}),`
`]}),`
`,e.jsx("br",{}),`
`,e.jsx(s.hr,{}),`
