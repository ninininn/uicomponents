import{u as d,j as e,M as t,T as r,P as c,C as i}from"./iframe-UhzdqN6V.js";import"./preload-helper-DLLWEBaG.js";function l(s){const n={blockquote:"blockquote",br:"br",code:"code",h1:"h1",h3:"h3",hr:"hr",li:"li",p:"p",pre:"pre",strong:"strong",ul:"ul",...d(),...s.components};return e.jsxs(e.Fragment,{children:[e.jsx(t,{isTemplate:!0,title:"How to use Dropdown"}),`
`,e.jsx(r,{}),`
...
`,e.jsx("div",{className:"sb-unstyled table-container overflow-hidden",children:e.jsxs("table",{className:"sb-unstyled table-content",children:[e.jsx("thead",{children:e.jsxs("tr",{className:"text-center",children:[e.jsx("td",{children:"methods"}),e.jsx("td",{children:"descriptions"}),e.jsx("td",{children:"inherit"})]})}),e.jsxs("tbody",{children:[e.jsxs("tr",{children:[e.jsx("td",{className:"font-bold",children:e.jsx(n.code,{children:".show()"})}),e.jsx("td",{children:"顯示綁定的下拉選單"}),e.jsx("td",{children:e.jsx(n.code,{children:"flowbiteDropdown"})})]}),e.jsxs("tr",{children:[e.jsx("td",{className:"font-bold",children:e.jsx(n.code,{children:".hide()"})}),e.jsx("td",{children:"隱藏綁定的下拉選單"}),e.jsx("td",{children:e.jsx(n.code,{children:"flowbiteDropdown"})})]}),e.jsxs("tr",{children:[e.jsx("td",{className:"font-bold",children:e.jsx(n.code,{children:".toggle()"})}),e.jsx("td",{children:"切換綁定的下拉選單顯示與否"}),e.jsx("td",{children:e.jsx(n.code,{children:"flowbiteDropdown"})})]}),e.jsxs("tr",{children:[e.jsx("td",{children:e.jsx(n.code,{children:".el"})}),e.jsx("td",{children:"回傳該元件渲染的 DOM 節點元素"}),e.jsx("td",{children:e.jsx(n.code,{children:"BaseComponent"})})]}),e.jsxs("tr",{children:[e.jsx("td",{children:e.jsx(n.code,{children:".getdropDownInstance()"})}),e.jsx("td",{children:"回傳該元件instance object"})]}),e.jsxs("tr",{children:[e.jsx("td",{children:e.jsx(n.code,{children:".getDropdownChildren()"})}),e.jsxs("td",{children:["回傳 ",e.jsx(n.code,{children:"dropdownChildren"})," 屬性"]})]}),e.jsxs("tr",{children:[e.jsx("td",{children:e.jsx(n.code,{children:".getTargetDropdown()"})}),e.jsxs("td",{children:["回傳 ",e.jsx(n.code,{children:"<ul>"})," 節點"]})]}),e.jsxs("tr",{children:[e.jsx("td",{children:e.jsx(n.code,{children:".getBindSelect()"})}),e.jsxs("td",{children:["回傳 ",e.jsx(n.code,{children:"<select>"})," 節點"]})]}),e.jsxs("tr",{children:[e.jsx("td",{children:e.jsx(n.code,{children:".clearDropdown()"})}),e.jsxs("td",{children:["清除 ",e.jsx(n.code,{children:"<ul>"}),"&",e.jsx(n.code,{children:"<select>"}),"子節點"]})]}),e.jsxs("tr",{children:[e.jsx("td",{children:e.jsx(n.code,{children:".renderDropdownChildren(...args)"})}),e.jsxs("td",{children:["重新渲染節點(單純渲染節點、不改value)；通常會接著搭配 ",e.jsx(n.code,{children:".updateValue()"}),"使用"]})]}),e.jsxs("tr",{children:[e.jsx("td",{children:e.jsx(n.code,{children:".updateValue()"})}),e.jsxs("td",{children:["更新預設 ",e.jsx(n.code,{children:"<select>"})," 的value值(通常render完設定為第一項，如果",e.jsx(n.code,{children:"<select>"}),"本身有selected option 則以它為主)"]})]})]})]})}),`
